...
class LLMManager:
    ...
    def __init__(self, openai_api_key: str, groq_api_key: str):
        ...
        self.parser = JsonOutputParser(pydantic_object=LeadDetails)
...
class DataValidator:
    ...
    def validate_data(data: Dict[str, Any]) -> Dict[str, Any]:
        """Validate data against the LeadDetails model.
        ...
        """
        return LeadDetails(**data).model_dump()
    ...
    def validate_data_check(
        ...
        Raises:
            ValidationError: If validation fails
        """
        return LeadDetails(**{**data, **data_clean})
    ...
    def validate_lead_score(lead_score: int) -> bool:
        ...
        Args:
            lead_score: The lead score to validate

        Returns:
            True if the lead_score is valid, False otherwise
        """
        return 0 <= lead_score <= 100


class CreateLeadManager:
    """Manager for CRM leads."""
    ...
    def __init__(self):
        ...
        # API configuration
        self.api_base_url = os.getenv("LEAD_API_BASE_URL")
    ...
    def prompt_for_mandatory_fields(self):
        ...
        mandatory_fields = ["first_name", "email"]
        missing_fields = [
            field
        ...
        if query.lower() == "submit":
            try:
                ...
                if input("Do you want to submit this data? (y/n): ").lower() == "y":
                    response = self.api_client.create_lead(data=validated_data)
            ...
            try:
                ...
                for field, value in cleaned_data.items():
                    if field == "lead_score":
                        if not DataValidator.validate_lead_score(value):
                            print(
    ...
    def run_interactive_session(self, state):
        """Run an interactive session for lead management."""
        print("CRM Lead Manager - Interactive Session")
        print("Type 'help' for available commands.")
        print("How can I help you create a lead?")
